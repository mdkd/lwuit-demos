...
/*
 * Represents a tapable Image Grid with the ability to 
 * swap images by dragging them from their current position
 * to a position occupied by another image.
 */
public class ImageGrid 
    ...
    public ImageGrid() {
        ...
        //The Done command is used to signal the completion of the swapping
        ...
        getContentPane().getStyle().setBgColor(0x000000, true);
